            ...
            if (password_verify($password, $passwordx)) {
                if ($active == 1) {
                    ...
                    if ($type_user == "Pessoa" and $active_person == 1) {
                        ...
                        if ($login == 0) {
                            header("Location: ../be/pages/homePerson.php");
                        } else {
                            header("Location: ../be/pages/homePerson.php");
                        }
                    } else if ($type_user == "Pessoa" and $active_person == 0) {
                        include "logout.php";
                        header("Location: ../be/pages/messageRegister.php");
                    } else if ($type_user == "Empresa") {
                        include "matchComp.php";
                        header("Location: ../be/pages/homeComp.php");
                    } else if ($type_user == "Universidade") {
                        include "matchHei.php";
                        header("Location: ../be/pages/homeHei.php");
                    } else if ($type_user == "Tutor") {
                        header("Location: ../be/pages/homeTutor.php");
                    ...
                    header("Location: ../be/pages/login.php");
                    $_SESSION["login"] = 1;
                }
            } else {
                session_start();
