    ...
    if (!empty($_POST["descricao"]) && $_FILES["fileToUpload"]['size'] != 0) {
        ...
        if (isset($_POST["but_upload"])) {
            ...
            if ($check !== false) {
                ...
                header("Location: ../is/pages/uploadStory.php");
                $_SESSION["xp_jovem"] = 1;
                $uploadOk = 0;
            }
        }
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                if (mysqli_stmt_prepare($stmt, $query)) {
                    ...
                    $query2 = "INSERT INTO experiences (description_is, xp_type, users_idusers, content_idcontent) VALUES (?,?,?,?)";
        ...
        $query = "INSERT INTO experiences (description_is, xp_type, users_idusers) VALUES (?,?,?)";
