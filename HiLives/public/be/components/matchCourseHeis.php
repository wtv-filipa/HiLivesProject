...
if ($_SESSION["idUser"]) {
    ...
    $query1 = "SELECT users_has_courses.users_idusers, users_has_courses.courses_idcourses, courses.idcourses, courses.name_course_be, courses.users_idusers, users.name_user, users.user_type_iduser_type
...
?>
    <div class="container">
        ...
        <h1 class="pb-2">Kandidaten | Cursussen in instellingen voor hoger onderwijs</h1>
        <p class="pb-4">Op deze pagina vindt u al uw links met mogelijke kandidaten voor cursussen in instellingen voor hoger onderwijs.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listStudy text-center">
                                ...
                                <a href="viewProfile.php?user=<?= $userPerson ?>&userType=<?= $iduser_type ?>" title="Bekijk het profiel van <?= $name_user ?>">
                                    <h4><?= $name_user ?></h4>
                                </a>
                                <a href="infoCourse.php?course=<?= $courses_idcourses ?>" title="Cursusinformatie weergeven <?= $name_course ?>">
                                    <p><?= $name_course ?></p>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card text-center shadowCard o-hidden border-0">
                                <div class="card-body  pt-5 pb-5">
                                    ...
                                    <p class="mx-auto" style="font-size: 1rem;">
                                        Je hebt nog geen verbinding met je cursussen. Kom later terug.
                                    </p>
                                </div>
                            </div>
                        </div>
