            ...
            <div class="container">
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            $message = "Cursus met succes bewerkt";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 2:
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="courses" role="tabpanel" aria-labelledby="courses-tab">
                                ...
                                ?>
                                            <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                                <div class="items itemsStudy itemsBigger">
                                                    ...
                                                    <div>
                                                        <a href="editCourseHei.php?course=<?= $idcourses ?>" class="linkIconsStudy" title="De cursus bewerken <?= $name_course ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourseHei<?= $idcourses ?>" class="linkIconsStudy" title="De cursus verwijderen <?= $name_course ?>">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            Op dit moment is er nog geen cursus toegevoegd.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadCourseHei.php" title="Een nieuwe cursus toevoegen">
                                    <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Nieuwe cursussen toevoegen</button>
                                </a>
                            </div>
