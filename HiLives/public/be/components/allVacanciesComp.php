...
if ($_SESSION["idUser"]) {
    ...
    $query1 = "SELECT idvacancies, vacancy_name_be, areas_idareas, name_interested_area_be
    FROM vacancies
...
?>
    <div class="container">
        ...
        if (isset($_SESSION["vac"])) {
            ...
            switch ($_SESSION["vac"]) {
                case 1:
                    $message = "Vacature succesvol geladen!";
                    $class = "alert-success";
                    $_SESSION["vac"] = 0;
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    $message = "Vacature succesvol weggewerkt!";
                    $class = "alert-success";
                    $_SESSION["vac"] = 0;
                    break;
                case 0:
        ...
        <h1 class="pb-2">Mijn vacatures</h1>
        <p class="pb-4">Hier kunt u al uw gepubliceerde vacatures tot nu toe beheren.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listWork text-center">
                                <a href="infoVacancy.php?vac=<?= $idvacancies ?>" title="Bekijk vacature informatie <?= $vacancy_name ?>">
                                    <h4><?= $vacancy_name ?></h4>
                                </a>
                            ...
                            <div class="card text-center shadowCard o-hidden border-0">
                                <div class="card-body  pt-5 pb-5">
                                    ...
                                    <p class="mx-auto" style="font-size: 1rem;">
                                        Op dit moment is er geen vacature toegevoegd.
                                    </p>
                                </div>
                            </div>
                        </div>
