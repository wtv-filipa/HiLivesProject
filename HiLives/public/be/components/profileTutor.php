...
?>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <a class="marginButtonProfile col-md-6 text-sm-start text-md-end buttonEdit" href="../../scripts/logout_be.php" title="Afmelden">
                    ...
                    <div class="col-12">
                        <div class="pe-3">
                            <div class="avatar-upload">
                                ...
                                ?>
                                    <img id="img_perf" class="image_profile mb-4" src="../../../admin/uploads/img_perfil/<?= $profile_img ?>" alt="profielfoto" title="profielfoto" />
                                <?php
                                } else {
                                ?>
                                    <img id="img_perf" class="image_profile mb-4" src="../../img/no_profile_img.png" alt="geen profielfoto" title="geen profielfoto" />
                                <?php
                                }
                                ?>
                            </div>
                ...
                <section class="pb-5">
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-tab" data-bs-toggle="tab" data-bs-target="#edit" type="button" role="tab" aria-controls="edit" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Profiel bewerken</span>
                            </button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row pt-4">
                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Contact</b>: <?= $contact_user ?></p>
                                    </div>
                                </div>

                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>E-mail</b>: <?= $email_user ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="edit" role="tabpanel" aria-labelledby="edit-tab">
                            <form method="post" role="form" id="register-form" action="../../scripts/editProfileTutor_be.php?edit=<?= $idUser ?>">
                                ...
                                <div class="text-center textForm">
                                    <a class="small" title="Klik om uw wachtwoord te herstellen" href="#" title="Klik om uw wachtwoord te herstellen">Wilt u uw wachtwoord wijzigen? Klik hier.</a>
                                </div>
