                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="paddingForms">
                                    ...
                                    <form method="post" role="form" id="register-form" action="../../scripts/editStory_be.php?xp=<?= $idStory ?>">
                                        <!--DESCRIPTION-->
                                        <div class="form-group pb-4">
                                            <label class="boldFont mt-3 pb-2" for="descricao">Beschrijving <span class="asterisk">*</span></label>
                                            <textarea class="form-control " id="descricao" rows="5" name="descricao" placeholder="Beschrijf je verhaal" aria-required="true" required="required"><?= $description ?></textarea>
                                        </div>

                                        <div class="form-group text-center mt-2">
                                            <div class="mx-auto col-sm-10 pb-3 pt-2">
                                                <button type="submit" class="btn buttonDesign buttonWork buttonLoginSize">Houden</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
