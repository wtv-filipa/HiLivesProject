...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.birth_date, users.description_be, users.website, users.facebook, users.instagram, users.profile_img, region.name_region_be
    FROM users 
    ...
    //Experiences
    $query2 = "SELECT idexperiences, description_be, date, xp_type, content_idcontent, idContent, content_name
    FROM experiences
    ...
    //Regions
    $query3 = "SELECT idvacancies, vacancy_name_be, date_vac, name_interested_area_be
    FROM vacancies
            ...
            <div class="container">
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            $message = "Vacature succesvol bewerkt";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 2:
                            ...
                            break;
                        case 4:
                            $message = "Geschiedenis succesvol bewerkt!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 5:
                    ...
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="vacancies-tab" data-bs-toggle="tab" data-bs-target="#vacancies" type="button" role="tab" aria-controls="vacancies" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Vacatures</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="vacancies" role="tabpanel" aria-labelledby="vacancies-tab">
                                            ...
                                            <div class="items itemsWork itemsBigger">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-end">
                                                        <a href="editVacancy.php?vac=<?= $idvacancies ?>" class="linkIcons" title="Bewerk de vacature <?= $vacancy_name ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deletevac<?= $idvacancies ?>" class="linkIcons" title="Verwijder de vacature <?= $vacancy_name ?>">
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadVacancy.php" title="Nieuwe vacatures toevoegen">
                                    <button class="btn buttonDesign buttonWork buttonRegisterSizeHEI m-0">Nieuwe vacatures toevoegen</button>
                                </a>
                            </div>
                                    ...
                                    <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                        <div class="items itemsWork itemsSmaller">
                                            <p class="mb-0">
                                                ...
                                                <a class="linkContacts align-middle" title="Klik om Facebook te bezoeken" href="https://www.facebook.com/<?= $facebook ?>" target="_blank"> <?= $facebook ?></a>
                                            </p>
                                        </div>
                                    </div>
                                <?php
                                    ...
                                    <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                        <div class="items itemsWork itemsSmaller">
                                            <p class="mb-0">
                                                ...
                                                <a class="linkContacts align-middle" title="Klik om Instagram te bezoeken" href="https://www.instagram.com/<?= $instagram ?>" target="_blank"> <?= $instagram ?></a>
                                            </p>
                                        </div>
                                    </div>
                                <?php
                                            ...
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        Op dit moment heeft het geen geschiedenis toegevoegd.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
