...
if (isset($_SESSION["idUser"]) && isset($_GET["edit"])) {
    ...
    if ($idUser == $id_navegar) {
        ...
        $query6 = "SELECT idlearning_type, name_learning_be
        FROM learning_type";

        $query7 = "SELECT idinstitution_type, name_institution_type_be
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <form class="ps-3" method="post" role="form" action="../../scripts/editProfileHei_be.php?edit=<?= $idUser ?>">
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="username" name="nome" placeholder="Schrijf hier de naam van de instelling voor hoger onderwijs" aria-required="true" required="required" value="<?= $name_user ?>">
                                            </div>
                                        </div>
                                        <!--EMAIL-->
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="email" class="form-control greyBorder" id="email" name="email" placeholder="Schrijf hier de e-mail van de instelling voor hoger onderwijs" aria-required="true" required="required" onchange="email_validate(this.value);" value="<?= $email_user ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="phone" name="phone" placeholder="Schrijf hier de telefonische contactpersoon van de instelling voor hoger onderwijs" aria-required="true" required="required" value="<?= $contact_user ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="site" name="site" placeholder="Vul hier de website van de Instelling voor Hoger Onderwijs in" aria-required="true" required="required" value="<?= $website ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="endereco" name="endereco" placeholder="Vul hier het volledige adres van de instelling voor hoger onderwijs in" aria-required="true" required="required" value="<?= $address ?>">
                                            </div>
                                        </div>

                                        <!--COUNTRY-->
                                        <div class="form-group pb-4">
                                            <label class="boldFont mt-3 pb-2" for="pais">Land van de instelling voor hoger onderwijs <span class="asterisk">*</span></label>
