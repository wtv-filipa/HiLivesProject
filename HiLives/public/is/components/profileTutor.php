...
?>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <a class="marginButtonProfile col-md-6 text-sm-start text-md-end buttonEdit" href="../../scripts/logout_is.php" title="Skráðu þig út">
                    ...
                    <div class="col-12">
                        <div class="pe-3">
                            <div class="avatar-upload">
                                ...
                                ?>
                                    <img id="img_perf" class="image_profile mb-4" src="../../../admin/uploads/img_perfil/<?= $profile_img ?>" alt="prófílmynd" title="prófílmynd" />
                                <?php
                                } else {
                                ?>
                                    <img id="img_perf" class="image_profile mb-4" src="../../img/no_profile_img.png" alt="engin prófílmynd" title="engin prófílmynd" />
                                <?php
                                }
                                ?>
                            </div>
                ...
                <section class="pb-5">
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-tab" data-bs-toggle="tab" data-bs-target="#edit" type="button" role="tab" aria-controls="edit" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Breyta forstillingu</span>
                            </button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="edit" role="tabpanel" aria-labelledby="edit-tab">
                            <form method="post" role="form" id="register-form" action="../../scripts/editProfileTutor_is.php?edit=<?= $idUser ?>">
                                ...
                                <div class="text-center textForm">
                                    <a class="small" title="Smelltu til að endurheimta lykilorðið þitt" href="construction.php" title="Smelltu til að endurheimta lykilorðið þitt">Þarftu að breyta lykilorðinu þínu? Smelltu hér.</a>
                                </div>
