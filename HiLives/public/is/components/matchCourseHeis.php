...
if ($_SESSION["idUser"]) {
    ...
    $query1 = "SELECT users_has_courses.users_idusers, users_has_courses.courses_idcourses, courses.idcourses, courses.name_course_is, courses.users_idusers, users.name_user, users.user_type_iduser_type
...
?>
    <div class="container">
        ...
        <h1 class="pb-2">Frambjóðendur | Námskeið í æðri menntastofnunum</h1>
        <p class="pb-4">Á þessari síðu finnur þú alla tengla þína við mögulega umsækjendur um námskeið í æðri menntastofnunum.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listStudy text-center">
                                ...
                                <a href="viewProfile.php?user=<?= $userPerson ?>&userType=<?= $iduser_type ?>" title="Sjá svæði þar sem <?= $name_user ?>">
                                    <h4><?= $name_user ?></h4>
                                </a>
                                <a href="infoCourse.php?course=<?= $courses_idcourses ?>" title="Skoða upplýsingar um námskeið <?= $name_course ?>">
                                    <p><?= $name_course ?></p>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card text-center shadowCard o-hidden border-0">
                                <div class="card-body  pt-5 pb-5">
                                    ...
                                    <p class="mx-auto" style="font-size: 1rem;">
                                        Þú hefur engin tengsl við námskeiðin þín ennþá. Vinsamlega komið aftur síðar.
                                    </p>
                                </div>
                            </div>
                        </div>
