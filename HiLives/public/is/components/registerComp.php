                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="paddingForms">
                                ...
                                <form method="post" role="form" id="register-form" action="../../scripts/registerComp_is.php">
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="username" name="nome" placeholder="Skrifaðu hér nafn fyrirtækisins" aria-required="true" required="required">
                                        </div>
                                    </div>
                                    <!--EMAIL-->
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="email" class="form-control greyBorder" id="email" name="email" placeholder="Skrifaðu hér tölvupóst fyrirtækisins" aria-required="true" required="required" onchange="email_validate(this.value);">
                                        </div>
                                    </div>
                                    <!--PASSWORD-->
                                    <div class="form-group pb-4">
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="date" class="form-control greyBorder" id="data_nasc" name="data_nasc" placeholder="Dagsetning grunns" aria-required="true" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <!--COUNTRY-->
                                    <div class="form-group pb-4">
                                        <label class="boldFont mt-3 pb-2" for="pais">Velja land fyrirtækis <span class="asterisk">*</span></label>
                                    ...
                                    <div class="form-group pb-4">
                                        <label class="boldFont mt-3 pb-2" for="site">
                                            Vefsetur <span class="asterisk">*</span>
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="site" name="site" placeholder="Inn á heimasíðu félagsins hér" aria-required="true" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="face" name="face" placeholder="Sláðu inn Facebook félagsins hér">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <textarea class="form-control " id="exp_t" rows="5" name="desc" placeholder="Skrifaðu lýsingu hér" aria-required="true" required="required"></textarea>
                                    </div>
