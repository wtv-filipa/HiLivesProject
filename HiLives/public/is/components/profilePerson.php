...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.birth_date, users.work_xp_is, users.profile_img, user_type.type_user, educ_lvl.name_education_is
    FROM users 
    ...
    //Environments
    $query8 = "SELECT work_environment_idwork_environment, name_environment_is 
            ...
            <div class="container">
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            $message = "Námskeið/námsskrá tókst að breyta";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 2:
                            ...
                            break;
                        case 3:
                            $message = "Námskeiðshleðslu/námskráreiningu lokið!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 4:
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            $message = "Námskeið / námskráreining tókst að útrýma!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 7:
                ...
                <section class="text-center pt-5 pb-3">
                    ...
                    ?>
                    <h1 class="pb-2"><?= $name_user ?> | <?= $age ?> Ára</h1>
                    <p>Áhugaverð svæði:
                        <?php
                        $first = true;
                ...
                <section class="pb-5">
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="studies-tab" data-bs-toggle="tab" data-bs-target="#studies" type="button" role="tab" aria-controls="studies" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Fræði</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="areas-tab" data-bs-toggle="tab" data-bs-target="#areas" type="button" role="tab" aria-controls="areas" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Svæði</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="skills-tab" data-bs-toggle="tab" data-bs-target="#skills" type="button" role="tab" aria-controls="skills" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Hæfni</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="env-tab" data-bs-toggle="tab" data-bs-target="#env" type="button" role="tab" aria-controls="env" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Umhverfi</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="studies" role="tabpanel" aria-labelledby="studies-tab">
                            <div class="pt-4">
                                <h4>Stig rannsókna</h4>
                                <p><?= $name_education ?></p>
                            </div>
                            <div class="row pt-3">
                                <h4 class="pb-3">Námskeið/ námseiningar gerðar</h4>
                                <?php
                                $stmt2 = mysqli_stmt_init($link2);
                                                ...
                                                <div class="items itemsStudy itemsBigger">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 text-end">
                                                            <a href="editCourse.php?uc=<?= $iddone_cu ?>" class="linkIconsStudy" title="Breyta námskeiði/námskráreiningu <?= $cu_name ?>">
                                                            ...
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourse<?= $iddone_cu ?>" class="linkIconsStudy" title="Eyða námskeiðinu/námskráreiningunni <?= $cu_name ?>">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            Á þessari stundu hefur þú ekki bætt við námskeiði / námskrá.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadCourse.php" title="Bæta við námskeiði eða námskrá">
                                    <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Bæta við nýjum rannsóknum</button>
                                </a>
                            </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        Í augnablikinu hefur þú enga sögu bætt við.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
