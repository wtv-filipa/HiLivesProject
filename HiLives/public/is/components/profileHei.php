...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.address, users.website, users.profile_img, learning_type.name_learning_is, institution_type.name_institution_type_is
    FROM users 
    ...
    //Experiences
    $query3 = "SELECT idexperiences, description_is, date, xp_type, content_idcontent, idContent, content_name
    FROM experiences
    ...
    //Regions
    $query4 = "SELECT idcourses, name_course_is, course_director 
    FROM courses 
    WHERE users_idusers = ?
            ...
            <div class="container">
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            $message = "Námskeiði tókst að breyta";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 2:
                    ...
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="courses-tab" data-bs-toggle="tab" data-bs-target="#courses" type="button" role="tab" aria-controls="courses" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Námskeið</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="courses" role="tabpanel" aria-labelledby="courses-tab">
                                ...
                                ?>
                                            <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                                <div class="items itemsStudy itemsBigger">
                                                    <h5><?= $name_course ?></h5>
                                                    <p class="cardInfo14 mb-2">Leikstjóri: <?= $course_director ?></p>
                                                    <div>
                                                        <a href="editCourseHei.php?course=<?= $idcourses ?>" class="linkIconsStudy" title="Breyta námskeiðinu <?= $course_director ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourseHei<?= $idcourses ?>" class="linkIconsStudy" title="Eyða námskeiðinu <?= $course_director ?>">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            Á þessum tíma hefur ekkert námskeið verið bætt við.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadCourseHei.php" title="Bæta við nýju námskeiði">
                                    <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Bæta við nýjum námskeiðum</button>
                                </a>
                            </div>
                            ...
                            <div class="row pt-4">
                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Gerð stofnunar</b>: <?= $name_institution_type ?></p>
                                    </div>
                                </div>

                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Tegund kennslu</b>: <?= $name_learning ?></p>
                                    </div>
                                </div>

                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Bústaður</b>: <?= $address ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
