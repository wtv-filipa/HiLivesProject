...
if ($_SESSION["idUser"]) {
    ...
    $query1 = "SELECT idvacancies, vacancy_name_es, areas_idareas, name_interested_area_es
    FROM vacancies
...
?>
    <div class="container">
        ...
        if (isset($_SESSION["vac"])) {
            ...
            switch ($_SESSION["vac"]) {
                case 1:
                    $message = "Vacante cargada con éxito!";
                    $class = "alert-success";
                    $_SESSION["vac"] = 0;
                    break;
                case 2:
        ...
        <h1 class="pb-2">Mis vacantes</h1>
        <p class="pb-4">Aquí puedes gestionar todas tus vacantes publicadas hasta el momento.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listWork text-center">
                                <a href="infoVacancy.php?vac=<?= $idvacancies ?>" title="Ver información sobre el trabajo <?= $vacancy_name ?>">
                                    <h4><?= $vacancy_name ?></h4>
                                </a>
                            ...
                            <div class="card text-center shadowCard o-hidden border-0">
                                <div class="card-body  pt-5 pb-5">
                                    ...
                                    <p class="mx-auto" style="font-size: 1rem;">
                                        En este momento no hay vacantes añadidas.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="text-center pt-4 pb-5">
            <a href="uploadVacancy.php" title="Añadir nuevos puestos de trabajo">
                <button class="btn buttonDesign buttonWork buttonRegisterSizeHEI m-0">Añadir nuevos puestos de trabajo</button>
            </a>
        </div>
