...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.address, users.website, users.profile_img, learning_type.name_learning_es, institution_type.name_institution_type_es
    FROM users 
    ...
    //Experiences
    $query3 = "SELECT idexperiences, description_es, date, xp_type, content_idcontent, idContent, content_name
    FROM experiences
    ...
    //Regions
    $query4 = "SELECT idcourses, name_course_es, course_director 
    FROM courses 
    WHERE users_idusers = ?
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="courses" role="tabpanel" aria-labelledby="courses-tab">
                                ...
                                ?>
                                            <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                                <div class="items itemsStudy itemsBigger">
                                                    <h5><?= $name_course ?></h5>
                                                    <p class="cardInfo14 mb-2">Director: <?= $course_director ?></p>
                                                    <div>
                                                        <a href="editCourseHei.php?course=<?= $idcourses ?>" class="linkIconsStudy" title="Editar el curso <?= $course_director ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourseHei<?= $idcourses ?>" class="linkIconsStudy" title="Eliminar el curso <?= $course_director ?>">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            Por el momento no hay ningún curso añadido.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadCourseHei.php" title="Añadir un nuevo curso">
                                    <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Añadir nuevos cursos</button>
                                </a>
                            </div>
                            ...
                            <div class="row pt-4">
                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Tipo de institución</b>: <?= $name_institution_type ?></p>
                                    </div>
                                </div>

                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Tipo de educación</b>: <?= $name_learning ?></p>
                                    </div>
                                </div>

                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Dirección</b>: <?= $address ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0">
                                            ...
                                            <a class="linkContacts align-middle" title="Haga clic para llamar <?= $contact_user ?>" href="tel:<?= $contact_user ?>"><?= $contact_user ?></a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0">
                                            ...
                                            <b class="ps-2 align-middle">Sitio web :</b>
                                        ...
                                        <div class="wrapperStory">
                                            <div class="row">
                                                ...
                                                <div class="col-2 text-end">
                                                    ...
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteStory<?= $idexperiences ?>" class="linkIcons" title="Borrar la historia">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                            <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                                                        </svg>
                                                    </a>
