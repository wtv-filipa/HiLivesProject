...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.birth_date, users.description_es, users.website, users.facebook, users.instagram, users.profile_img, region.name_region_es
    FROM users 
    ...
    //Experiences
    $query2 = "SELECT idexperiences, description_es, date, xp_type, content_idcontent, idContent, content_name
    FROM experiences
    ...
    //Regions
    $query3 = "SELECT idvacancies, vacancy_name_es, date_vac, name_interested_area_es
    FROM vacancies
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="marginButtonProfile col-12 col-md-6 text-sm-start text-md-end">
                        <a class="buttonEdit" href="editProfile.php?edit=<?= $idUser ?>" title="Ir a la edición de los datos del perfil">
                        ...
                        <a class="buttonEdit" href="../../scripts/logout_es.php" title="Cerrar la sesión">
                            ...
                            <span class="ps-1 align-middle textEdit">Cerrar la sesión</span>
                        </a>
                    </div>
                </div>
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            ...
                            break;
                        case 2:
                            $message = "¡Carga de la historia completada!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 4:
                            $message = "¡Historia editada con éxito!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 5:
                    ...
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="vacancies-tab" data-bs-toggle="tab" data-bs-target="#vacancies" type="button" role="tab" aria-controls="vacancies" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Vacantes</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="vacancies" role="tabpanel" aria-labelledby="vacancies-tab">
                                            ...
                                            <div class="items itemsWork itemsBigger">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-end">
                                                        <a href="editVacancy.php?vac=<?= $idvacancies ?>" class="linkIcons" title="Editar la vacante <?= $vacancy_name ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deletevac<?= $idvacancies ?>" class="linkIcons" title="Eliminar la vacante <?= $vacancy_name ?>">
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadVacancy.php" title="Añadir nuevos trabajos">
                                    <button class="btn buttonDesign buttonWork buttonRegisterSizeHEI m-0">Añadir nuevos trabajos</button>
                                </a>
                            </div>
                                ...
                                <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                    <div class="items itemsWork itemsSmaller">
                                        <p class="mb-0">
                                            ...
                                            <a class="linkContacts align-middle" title="Haga clic para enviar un correo electrónico a <?= $email_user ?>" href="mailto:<?= $email_user ?>"><?= $email_user ?></a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                    <div class="items itemsWork itemsSmaller">
                                        <p class="mb-0">
                                            ...
                                            <a class="linkContacts align-middle" title="Haga clic para visitar el sitio web" href="https://<?= $website ?>" target="_blank"><?= $website ?></a>
                                        </p>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                        <div class="items itemsWork itemsSmaller">
                                            <p class="mb-0">
                                                ...
                                                <a class="linkContacts align-middle" title="Haga clic para visitar el Facebook" href="https://www.facebook.com/<?= $facebook ?>" target="_blank"> <?= $facebook ?></a>
                                            </p>
                                        </div>
                                    </div>
                                <?php
                                    ...
                                    <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                        <div class="items itemsWork itemsSmaller">
                                            <p class="mb-0">
                                                ...
                                                <a class="linkContacts align-middle" title="Haga clic para visitar el Instagram" href="https://www.instagram.com/<?= $instagram ?>" target="_blank"> <?= $instagram ?></a>
                                            </p>
                                        </div>
                                    </div>
                                <?php
                        ...
                        <div class="tab-pane fade" id="stories" role="tabpanel" aria-labelledby="stories-tab">
                            <div class="text-center pt-4">
                                <a href="uploadStory.php" title="Añadir una nueva historia a HiLives">
                                    <button class="btn buttonDesign buttonWork buttonRegisterSizeHEI m-0">Añadir una historia</button>
                                </a>
                            </div>
                            <?php
                            $stmt2 = mysqli_stmt_init($link2);
                                            ...
                                            <div class="row">
                                                <header class="cf col-10">
                                                    <a href="profile.php?user=<?= $idUser ?>" title="Perfil de <?= $name_user ?>">
                                                        ...
                                                        ?>
                                                            <img class="profile-pic" src="../../img/no_profile_img.png" alt="sin foto de perfil" title="sin foto de perfil" />
                                                        <?php
                                                        }
                                                        ?>
                                                    </a>
                                                ...
                                                <div class="col-2 text-end">
                                                    <a href="editStory.php?edit=<?= $idexperiences ?>" class="linkIcons" title="Editar la historia">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square me-3" viewBox="0 0 16 16">
                                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                        </svg>
                                                    ...
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteStory<?= $idexperiences ?>" class="linkIcons" title="Eliminar la historia">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                            <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                                                        </svg>
                                                    </a>
                                            ...
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        Por el momento no hay ninguna historia añadida.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
