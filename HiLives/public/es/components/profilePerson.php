...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.birth_date, users.work_xp_es, users.profile_img, user_type.type_user, educ_lvl.name_education_es
    FROM users 
    ...
    //Environments
    $query8 = "SELECT work_environment_idwork_environment, name_environment_es 
            ...
            <div class="container">
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            $message = "Curso/unidad curricular editada con éxito";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 2:
                            ...
                            break;
                        case 3:
                            $message = "Carga del curso/unidad curricular completada";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 4:
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            $message = "¡Curso/unidad curricular eliminado con éxito!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 7:
                ...
                <section class="text-center pt-5 pb-3">
                    ...
                    ?>
                    <h1 class="pb-2"><?= $name_user ?> | <?= $age ?> años</h1>
                ...
                <section class="pb-5">
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="studies-tab" data-bs-toggle="tab" data-bs-target="#studies" type="button" role="tab" aria-controls="studies" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Estudios</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="skills-tab" data-bs-toggle="tab" data-bs-target="#skills" type="button" role="tab" aria-controls="skills" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Habilidades</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="env-tab" data-bs-toggle="tab" data-bs-target="#env" type="button" role="tab" aria-controls="env" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Entornos</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="studies" role="tabpanel" aria-labelledby="studies-tab">
                            ...
                            <div class="row pt-3">
                                <h4 class="pb-3">Cursos/plan de estudios Unidades realizadas</h4>
                                <?php
                                $stmt2 = mysqli_stmt_init($link2);
                                                ...
                                                <div class="items itemsStudy itemsBigger">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 text-end">
                                                            <a href="editCourse.php?uc=<?= $iddone_cu ?>" class="linkIconsStudy" title="Editar el curso/UC <?= $cu_name ?>">
                                                            ...
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourse<?= $iddone_cu ?>" class="linkIconsStudy" title="Suprimir curso/UC <?= $cu_name ?>">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            En este momento no tiene ningún curso/unidad curricular añadido.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadCourse.php" title="Añadir un curso o una unidad de curso">
                                    <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Añadir nuevos estudios</button>
                                </a>
                            </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        De momento no tienes ninguna historia añadida.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
