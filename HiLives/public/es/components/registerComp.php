                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="paddingForms">
                                ...
                                <form method="post" role="form" id="register-form" action="../../scripts/registerComp_es.php">
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="username" name="nome" placeholder="Escriba aquí el nombre de su empresa" aria-required="true" required="required">
                                        </div>
                                    </div>
                                    <!--EMAIL-->
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="email" class="form-control greyBorder" id="email" name="email" placeholder="Escriba aquí el correo electrónico de su empresa" aria-required="true" required="required" onchange="email_validate(this.value);">
                                        </div>
                                    </div>
                                    <!--PASSWORD-->
                                    <div class="form-group pb-4">
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="date" class="form-control greyBorder" id="data_nasc" name="data_nasc" placeholder="Fecha de fundación" aria-required="true" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <!--COUNTRY-->
                                    <div class="form-group pb-4">
                                        <label class="boldFont mt-3 pb-2" for="pais">Seleccione el país de la empresa <span class="asterisk">*</span></label>
                                    ...
                                    <div class="form-group pb-4">
                                        <label class="boldFont mt-3 pb-2" for="site">
                                            Página web <span class="asterisk">*</span>
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="site" name="site" placeholder="Entre aquí en el sitio web de la empresa" aria-required="true" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="face" name="face" placeholder="Inserte aquí el Facebook de la empresa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pb-4">
                                        ...
                                        <div class="p-0 m-0">
                                            <input type="text" class="form-control greyBorder" id="insta" name="insta" placeholder="Entra en el Instagram de la empresa aquí">
                                        </div>
                                    </div>
                                ...
                                <div class="text-center textForm">
                                    <a class="small" title="Haga clic para iniciar sessión" href="login.php">¿Ya está registrado? Accede a tu cuenta.</a>
                                </div>
                            </div>
                        </div>
                    </div>
