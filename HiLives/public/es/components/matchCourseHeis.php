...
if ($_SESSION["idUser"]) {
    ...
    $query1 = "SELECT users_has_courses.users_idusers, users_has_courses.courses_idcourses, courses.idcourses, courses.name_course_es, courses.users_idusers, users.name_user, users.user_type_iduser_type
...
?>
    <div class="container">
        ...
        <h1 class="pb-2">Solicitantes | Cursos en instituciones de enseñanza superior</h1>
        <p class="pb-4">En esta página encontrará todos los enlaces con posibles candidatos a cursos en instituciones de educación superior.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listStudy text-center">
                                ...
                                <a href="infoCourse.php?course=<?= $courses_idcourses ?>" title="Ver información del curso <?= $name_course ?>">
                                    <p><?= $name_course ?></p>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card text-center shadowCard o-hidden border-0">
                                <div class="card-body  pt-5 pb-5">
                                    ...
                                    <p class="mx-auto" style="font-size: 1rem;">
                                        Todavía no tiene ningún vínculo con sus cursos. Por favor, vuelva más tarde.
                                    </p>
                                </div>
                            </div>
                        </div>
