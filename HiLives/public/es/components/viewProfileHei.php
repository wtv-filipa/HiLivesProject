                                ...
                                ?>
                                            <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                                <div class="items itemsStudy itemsBigger">
                                                    <h5><?= $name_course ?></h5>
                                                    <p class="cardInfo14 mb-2">Diretor: <?= $course_director ?></p>
                                                </div>
                                            </div>
                                        <?php
                                        }
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            Esta institución de educación superior aún no ha compartido ningún curso.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        Esta institución de educación superior aún no ha compartido ninguna historia.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
