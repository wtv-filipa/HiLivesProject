...
if (isset($_SESSION["idUser"])) {
    ...
    $query1 = "SELECT idcourses, name_course_es, course_director
                FROM courses
    ...
    <div class="container">
        ...
        if (isset($_SESSION["course"])) {
            ...
            switch ($_SESSION["course"]) {
                case 1:
                    $message = "Curso cargado con éxito!";
                    $class = "alert-success";
                    $_SESSION["course"] = 0;
                    break;
                case 2:
        ...
        <h1 class="pb-2">Mis cursos</h1>
        <p class="pb-4">Aquí puedes gestionar todos tus cursos publicados hasta el momento.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listStudy text-center">
                                <a href="infoCourse.php?course=<?= $idcourses ?>" title="Ver información del curso <?= $name_course ?>">
                                    <h4><?= $name_course ?></h4>
                                </a>
                                <p>Director(a): <?= $course_director ?></p>
                                <div>
                                    <a href="editCourseHei.php?course=<?= $idcourses ?>" class="linkIconsStudy" title="Editar el curso <?= $name_course ?>">
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourseHei<?= $idcourses ?>" class="linkIconsStudy" title="Eliminar el curso <?= $name_course ?>">
        ...
        <div class="text-center pt-4 pb-5">
            <a href="uploadCourseHei.php" title="Añadir un nuevo curso">
                <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Añadir un nuevo curso</button>
            </a>
        </div>
