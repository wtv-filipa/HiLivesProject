...
if ($_SESSION["idUser"]) {
    ...
    $query1 = "SELECT idvacancies, vacancy_name_en, areas_idareas, name_interested_area_en
    FROM vacancies
...
?>
    <div class="container">
        ...
        if (isset($_SESSION["vac"])) {
            ...
            switch ($_SESSION["vac"]) {
                case 1:
                    $message = "Vacancy successfully uploaded!";
                    $class = "alert-success";
                    $_SESSION["vac"] = 0;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    $message = "Vacancy successfully edited!";
                    $class = "alert-success";
                    $_SESSION["vac"] = 0;
                    break;
                case 4:
                    $message = "Vacancy successfully eliminated!";
                    $class = "alert-success";
                    $_SESSION["vac"] = 0;
                    break;
                case 0:
        ...
        <h1 class="pb-2">My vacancies</h1>
        <p class="pb-4">Here you can manage all your published vacancies so far.</p>
            ...
            ?>
                        <div id="cardMatch" class="col-12 col-md-6 col-lg-4 pb-4">
                            <div class="list listWork text-center">
                                <a href="infoVacancy.php?vac=<?= $idvacancies ?>" title="See information on the vacancy <?= $vacancy_name ?>">
                                    <h4><?= $vacancy_name ?></h4>
                                </a>
                            ...
                            <div class="card text-center shadowCard o-hidden border-0">
                                <div class="card-body  pt-5 pb-5">
                                    ...
                                    <p class="mx-auto" style="font-size: 1rem;">
                                        At the moment there are no vacancies added.
                                    </p>
                                </div>
                            </div>
                        </div>
