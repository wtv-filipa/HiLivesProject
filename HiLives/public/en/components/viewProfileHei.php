...
?>
            <div class="container">
                ...
                <section class="text-center pt-5 pb-3">
                    ...
                    ?>
                        <img class="imgProfile mb-4" src="../../img/no_profile_img.png" alt="without profile picture" title="without profile picture" />
                    <?php
                    }
                    ?>
                    ...
                    <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            This Higher Education Institution hasn't shared any courses yet.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="infos" role="tabpanel" aria-labelledby="infos-tab">
                            <div class="row pt-4">
                                ...
                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Type of teaching</b>: <?= $name_learning ?></p>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        This Higher Education Institution hasn't shared any stories yet.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
