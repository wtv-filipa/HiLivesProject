...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.birth_date, users.work_xp_en, users.profile_img, user_type.type_user, educ_lvl.name_education_en
    FROM users 
...
?>
            <div class="container">
                ...
                <section class="text-center pt-5 pb-3">
                    ...
                    ?>
                    <h1 class="pb-2"><?= $name_user ?> | <?= $age ?> years</h1>
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            This person hasn't added any completed Courses/Curriculum Units yet.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        This person hasn't shared any stories yet.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
