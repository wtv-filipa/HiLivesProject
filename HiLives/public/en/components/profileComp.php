...
?>
            <div class="container">
                ...
                <section class="text-center pt-5 pb-3">
                    ...
                    ?>
                        <img class="imgProfile mb-4" src="../../../admin/uploads/img_perfil/<?= $profile_img ?>" alt="<?= $profile_img ?>" title="Profile picture of <?= $name_user ?>" />
                    <?php
                    } else {
                    ?>
                        <img class="imgProfile mb-4" src="../../img/no_profile_img.png" alt="no profile picture" title="no profile picture" />
                    <?php
                    }
                    ?>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="vacancies" role="tabpanel" aria-labelledby="vacancies-tab">
                                            ...
                                            <div class="items itemsWork itemsBigger">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-end">
                                                        <a href="editVacancy.php?vac=<?= $idvacancies ?>" class="linkIcons" title="Edit the vacancy <?= $vacancy_name ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deletevac<?= $idvacancies ?>" class="linkIcons" title="Delete the vacancy <?= $vacancy_name ?>">
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadVacancy.php" title="Add new vacancies">
                                    <button class="btn buttonDesign buttonWork buttonRegisterSizeHEI m-0">Add new vacancies</button>
                                </a>
                            </div>
