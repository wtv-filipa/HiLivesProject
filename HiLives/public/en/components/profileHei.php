...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.address, users.website, users.profile_img, learning_type.name_learning_en, institution_type.name_institution_type_en
    FROM users 
    ...
    //Experiences
    $query3 = "SELECT idexperiences, description_en, date, xp_type, content_idcontent, idContent, content_name
    FROM experiences
    ...
    //Regions
    $query4 = "SELECT idcourses, name_course_en, course_director 
    FROM courses 
    WHERE users_idusers = ?
                    ...
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="courses-tab" data-bs-toggle="tab" data-bs-target="#courses" type="button" role="tab" aria-controls="courses" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Courses</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                                ...
                                ?>
                                            <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                                <div class="items itemsStudy itemsBigger">
                                                    ...
                                                    <div>
                                                        <a href="editCourseHei.php?course=<?= $idcourses ?>" class="linkIconsStudy" title="Edit the course <?= $course_director ?>">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourseHei<?= $idcourses ?>" class="linkIconsStudy" title="Delete the course <?= $course_director ?>">
                            ...
                            <div class="row pt-4">
                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Type of institution</b>: <?= $name_institution_type ?></p>
                                    </div>
                                </div>

                                <div id="cardInfo" class="col-12 col-md-6 pb-3">
                                    <div class="items itemsStudy itemsSmaller">
                                        <p class="mb-0"><b>Type of education</b>: <?= $name_learning ?></p>
                                    </div>
                                </div>
                                        ...
                                        <div class="wrapperStory">
                                            <div class="row">
                                                <header class="cf col-10">
                                                    <a href="profile.php?user=<?= $idUser ?>" title="Profile of <?= $name_user ?>">
                                                        ...
                                                        ?>
                                                            <img class="profile-pic" src="../../img/no_profile_img.png" alt="withou profile image" title="withou profile image" />
                                                        <?php
                                                        }
                                                        ?>
                                                    </a>
                                            ...
                                            ?>
                                                ...
                                                <div class="text-center videoSize">
                                                    <img class="img-content img-fluid" title="<?= $content_name ?>" src="../../../admin/uploads/experiences/<?= $content_name ?>" />
                                                </div>
                                            <?php
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        At the moment there is no story added.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
