...
if (isset($_SESSION["idUser"]) && isset($_GET["edit"])) {
    ...
    if ($idUser == $id_navegar) {
        ...
        $query6 = "SELECT idlearning_type, name_learning_en
        FROM learning_type";

        $query7 = "SELECT idinstitution_type, name_institution_type_en
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <form class="ps-3" method="post" role="form" action="../../scripts/editProfileHei_en.php?edit=<?= $idUser ?>">
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="username" name="nome" placeholder="Type here the name of the Higher Education Institution" aria-required="true" required="required" value="<?= $name_user ?>">
                                            </div>
                                        </div>
                                        <!--EMAIL-->
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="email" class="form-control greyBorder" id="email" name="email" placeholder="Type here the email of the Higher Education Institution" aria-required="true" required="required" onchange="email_validate(this.value);" value="<?= $email_user ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="phone" name="phone" placeholder="Type here the phone number of the Higher Education Institution" aria-required="true" required="required" value="<?= $contact_user ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group pb-4">
                                            ...
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="site" name="site" placeholder="Type here the Website of the Higher Education Institution" aria-required="true" required="required" value="<?= $website ?>">
                                            </div>
                                        </div>

                                        <!--TIPO DE ENSINO-->
                                        <div class="form-group pb-4">
                                            <label class="boldFont mt-3 pb-2" for="ensino">Type of education of the Higher Education Institution <span class="asterisk">*</span></label>
                                        ...
                                        <!--TIPO DE INSTITUIÇÃO-->
                                        <div class="form-group pb-4">
                                            <label class="boldFont mt-3 pb-2" for="instituicao">Type of Higher Education Institution <span class="asterisk">*</span></label>
                                        ...
                                        <!--ADDRESS-->
                                        <div class="form-group pb-4">
                                            <label class="boldFont mt-3 pb-2" for="endereco">Address <span class="asterisk">*</span></label>
                                            <div class="p-0 m-0">
                                                <input type="text" class="form-control greyBorder" id="endereco" name="endereco" placeholder="Type here the complete address of the Higher Education Institution" aria-required="true" required="required" value="<?= $address ?>">
                                            </div>
                                        </div>

                                        <!--COUNTRY-->
                                        <div class="form-group pb-4">
                                            <label class="boldFont mt-3 pb-2" for="pais">Country of the Higher Education Institution <span class="asterisk">*</span></label>
                                        ...
                                        <div class="form-group pb-4 formulario" id="pt">
                                            <label class="boldFont mt-3 pb-2" for="regiao">Location of the Higher Education Institution <span class="asterisk">*</span></label>
