...
if (isset($_GET["user"]) && $_SESSION["idUser"]) {
    ...
    //General infos users
    $query = "SELECT users.idusers, users.name_user, users.email_user, users.contact_user, users.birth_date, description_en, users.work_xp_en, users.profile_img, user_type.type_user, educ_lvl.name_education_en
    FROM users 
    ...
    //Environments
    $query8 = "SELECT work_environment_idwork_environment, name_environment_en 
    ...
    if (mysqli_stmt_prepare($stmt, $query)) {
        ...
        mysqli_stmt_bind_result($stmt, $idusers, $name_user, $email_user, $contact_user, $birth_date, $description, $work_xp, $profile_img, $type_user, $name_education);
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="marginButtonProfile col-12 col-md-6 text-sm-start text-md-end">
                        <a class="buttonEdit" href="editProfile.php?edit=<?= $idUser ?>" title="Go to editing the profile data">
                            ...
                            <span class="ps-2 pe-3 align-middle textEdit">Edit Profile </span>
                        </a>
                        <a class="buttonEdit" href="../../scripts/logout_en.php" title="Logout from HiLives">
                ...
                if (isset($_SESSION["profile"])) {
                    ...
                    switch ($_SESSION["profile"]) {
                        case 1:
                            $message = "Course/Curriculum Unit successfully edited";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 2:
                            $message = "Story upload completed!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 3:
                            $message = "Upload of the Course/Curriculum Unit completed!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 4:
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            $message = "Course/Curriculum Unit successfully deleted!";
                            $class = "alert-success";
                            $_SESSION["profile"] = 0;
                            break;
                        case 7:
                ...
                <section class="text-center pt-5 pb-3">
                    ...
                    ?>
                        <img class="imgProfile mb-4" src="../../../admin/uploads/img_perfil/<?= $profile_img ?>" alt="<?= $profile_img ?>" title="Profile image from <?= $name_user ?>" />
                    <?php
                    } else {
                    ?>
                ...
                <section class="pb-5">
                    <ul class="nav nav-tabs nav-fill profileTabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="studies-tab" data-bs-toggle="tab" data-bs-target="#studies" type="button" role="tab" aria-controls="studies" aria-selected="true">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Studies</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="areas-tab" data-bs-toggle="tab" data-bs-target="#areas" type="button" role="tab" aria-controls="areas" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Areas</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="skills-tab" data-bs-toggle="tab" data-bs-target="#skills" type="button" role="tab" aria-controls="skills" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Skills</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="env-tab" data-bs-toggle="tab" data-bs-target="#env" type="button" role="tab" aria-controls="env" aria-selected="false">
                                ...
                                <span class="ps-2 align-middle textHideSmall">Environments</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="studies" role="tabpanel" aria-labelledby="studies-tab">
                            <div class="pt-4">
                                <h4>Level of studies</h4>
                                <p><?= $name_education ?></p>
                            </div>
                            <div class="row pt-3">
                                <h4 class="pb-3">Courses/Curriculum Units done</h4>
                                <?php
                                $stmt2 = mysqli_stmt_init($link2);
                                                ...
                                                <div class="items itemsStudy itemsBigger">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 text-end">
                                                            <a href="editCourse.php?uc=<?= $iddone_cu ?>" class="linkIconsStudy" title="Edit the course/ curricular unit <?= $cu_name ?>">
                                                            ...
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCourse<?= $iddone_cu ?>" class="linkIconsStudy" title="Delete the course/ curricular unit <?= $cu_name ?>">
                                                ...
                                                <div class="card text-center shadowCard o-hidden border-0">
                                                    <div class="card-body  pt-5 pb-5">
                                                        ...
                                                        <p class="mx-auto" style="font-size: 1rem;">
                                                            At the moment you don't have any Courses/Curriculum Units added.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center pt-4">
                                <a href="uploadCourse.php" title="Adicionar um curso ou unidade curricular">
                                    <button class="btn buttonDesign buttonStudy buttonRegisterSizeHEI m-0">Add new studies</button>
                                </a>
                            </div>
                        ...
                        <div class="tab-pane fade" id="stories" role="tabpanel" aria-labelledby="stories-tab">
                            <div class="text-center pt-4">
                                <a href="uploadStory.php" title="Add a new story to HiLives">
                                    <button class="btn buttonDesign buttonWork buttonRegisterSizeHEI m-0">Add a story</button>
                                </a>
                            </div>
                            <?php
                            $stmt2 = mysqli_stmt_init($link2);
                                        ...
                                        <div class="wrapperStory">
                                            <div class="row">
                                                <header class="cf col-10">
                                                    ...
                                                    <h5 class="name">
                                                        <a href="profile.php?user=<?= $idUser ?>" title="Profile of <?= $name_user ?>" class="linkStory"><?= $name_user ?> </a>
                                                    </h5>
                                                    <p class="cardInfo13"><?= $newDate ?></p>
                                                </header>

                                                <div class="col-2 text-end">
                                                    <a href="editStory.php?edit=<?= $idexperiences ?>" class="linkIcons" title="Edit story">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square me-3" viewBox="0 0 16 16">
                                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                        </svg>
                                                    ...
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteStory<?= $idexperiences ?>" class="linkIcons" title="Delete story">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                                            <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                                                        </svg>
                                                    </a>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card text-center shadowCard o-hidden border-0">
                                                <div class="card-body  pt-5 pb-5">
                                                    ...
                                                    <p class="mx-auto" style="font-size: 1rem;">
                                                        At the moment you don't have any stories added.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
