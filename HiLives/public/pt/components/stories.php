...
<div class="container pb-5">
    ...
    <p>Aqui, vais encontrar vídeos, fotografias, áudios e textos que demonstram como foram as experiências académicas e profissionais de outros utilizadores da HiLives. Podes também encontrar vídeos que mostram os ambientes das empresas ou universidades. Qualquer pessoa pode publicar a sua história! Adiciona a tua aqui!</p>

    <!--STORIES-->
    <!--Video-->
    <div class="wrapperStory">
        <header class="cf">
            <a href="profile.php" title="Ver a área de">
                <img class="profile-pic" src="../../img/no_profile_img.png" alt="sem imagem de perfil" title="Imagem padrão" />
            </a>
            <h5 class="name">
                <a href="profile.php" title="Ver a área de" class="linkStory">Filipa Ferreira</a>
            </h5>
