<section class="container-fluid bgGreyReq">
    <div class="container">
        ...
        <h3 class="pb-5 textPink">Mariana Silva</h3>
        <!--PROFILE STAGES BIG-->
        <div class="row pb-4 bigBg">
            <div class="col-12 text-center">
                <div class="imageLearn">
                    <img class="mb-4 img-fluid" src="../../img/status/pending_create1.svg" alt="símbolo de calendário" title="símbolo de calendário" />
                </div>
            </div>
        </div>
        ...
        <div class="row pb-4 smallBg">
            <div class="col-12 text-center">
                <div class="imageLearn">
                    <img class="mb-4 img-fluid" src="../../img/status/pending_create_small1.svg" alt="símbolo de calendário" title="símbolo de calendário" />
                </div>
            </div>
        </div>
...
<section class="jumbotron bgCoverSection CreateBg bigBg">
    <div class="bg-white bg-whiteSizeAdjust ps-5 pe-3">
        ...
        <h3 class="pb-4 text-center textPink">Mariana Silva</h3>
