<div class="container pb-5">
    ...
    <div class="mt-5">
        ...
        <div class="mt-5">
            ...
            <p>Se a Pessoa, Instituição de Ensino Superior ou empresa já se tiver registado anteriormente, poderá <u><a href="login.php" title="Clica para iniciares sessão" target="_blank">iniciar a sua sessão</a></u>
        </div>
    </div>
