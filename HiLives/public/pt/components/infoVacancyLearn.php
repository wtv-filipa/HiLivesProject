    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center pb-5">
                ...
                <p>3rd Cycle Degree in Basic Education</p>
            </div>
                ...
                <div id="cardInfos" class="col-12 col-md-6 col-lg-4 pb-3">
                    <div class="infos itemsInfosWork infosSmaller">
                        <p class="mb-0">
                            ...
                            <a class="linkContactsBlue align-middle" title="Clicar para enviar e-mail para geral@oli-world.pt" href="mailto:geral@oli-world.pt">geral@oli-world.pt</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="cardInfos" class="col-12 col-md-6 col-lg-4 pb-3">
                    <div class="infos itemsInfosWork infosSmaller">
                        <p class="mb-0">
                            ...
                            <a class="linkContactsBlue align-middle" title="Clicar para telefonar para 234300200" href="tel:234300200">234300200</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="cardInfos" class="col-12 col-md-6 col-lg-4 pb-3">
                    <div class="infos itemsInfosWork infosSmaller">
                        <p class="mb-0">
                            ...
                            <a class="linkContactsBlue align-middle" title="Clicar para visitar o website" href="https://www.oli-world.com/pt/" target="_blank">www.oli-world.com/pt/</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="cardInfos" class="col-12 col-md-6 col-lg-4 pb-3">
                    <div class="infos itemsInfosWork infosSmaller">
                        <p class="mb-0">
                            ...
                            <a class="linkContactsBlue align-middle" title="Clicar para visitar o Facebook" href="https://www.facebook.com/OLI.inspiredbywater/"> @OLI.inspiredbywater</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="cardInfos" class="col-12 col-md-6 col-lg-4 pb-3">
                    <div class="infos itemsInfosWork infosSmaller">
                        <p class="mb-0">
                            ...
                            <a class="linkContactsBlue align-middle" title="Clicar para visitar o Instagram" href="https://www.instagram.com/oli.inspiredbywater/">@oli.inspiredbywater</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane fade" id="stories" role="tabpanel" aria-labelledby="stories-tab">
            ...
            <div class="wrapperStory">
                <header class="cf">
                    ...
                    <h5 class="name">
                        <a href="profile.php" title="Ir para a área de" class="linkStory">Filipa Ferreira</a>
                    </h5>
