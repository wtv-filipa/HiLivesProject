                                ...
                                ?>
                                        <div id="cardInfo" class="col-12 col-md-6 col-lg-4 pb-3">
                                            <div class="items itemsStudy itemsBigger">
                                                ...
                                                <div>
                                                    <a href="editCourseHei.php?uc=<?= $idcourses ?>" class="linkIconsStudy" title="Editar o curso <?= $course_director ?>">
                                                    ...
                                                    <a href="#" class="linkIconsStudy" title="Eliminar o curso <?= $course_director ?>">
